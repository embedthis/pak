...
paks/ejs/dist/ejs.slots.h: $(DEPS_6)

#
#   pcre.h
#
DEPS_7 += paks/pcre/dist/pcre.h
...
$(BUILD)/obj/ejsLib.o: \
    paks/ejs/dist/ejsLib.c $(DEPS_13)
...
paks/http/dist/http.h: $(DEPS_15)

#
#   httpLib.o
#
DEPS_16 += paks/http/dist/http.h

$(BUILD)/obj/httpLib.o: \
    paks/http/dist/httpLib.c $(DEPS_16)
...
$(BUILD)/bin/libmprssl.so: $(DEPS_33)
	@echo '      [Link] $(BUILD)/bin/libmprssl.so'
	$(CC) -shared -o $(BUILD)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/mprSsl.o" $(LIBPATHS_33) $(LIBS_33) $(LIBS_33) $(LIBS) 
