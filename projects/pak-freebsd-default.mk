...
pak.mod: $(DEPS_33)
	/Users/mob/git/pak/freebsd-x86-default/bin/ejsc --out /Users/mob/git/pak/freebsd-x86-default/bin/pak.mod --optimize 9 src/pak.es
#
#   pak.o
#
...
DEPS_35 += $(CONFIG)/bin/bits/pak.mod
...
installBinary: $(DEPS_37)
	...
	ln -s "1.0.0" "$(BIT_APP_PREFIX)/latest"
