...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/pak-freebsd-default-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/pak-freebsd-default-bit.h >/dev/null ; then\
		cp projects/pak-freebsd-default-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
...
$(CONFIG)/obj/estLib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/estLib.o -fPIC $(DFLAGS) $(IFLAGS) src/cmd/paks/est/estLib.c
...
$(CONFIG)/obj/mprLib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/mprLib.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/paks/mpr/mprLib.c
...
$(CONFIG)/obj/mprSsl.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/mprSsl.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/paks/mpr/mprSsl.c
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_12)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LIBPATHS) "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_12) $(LIBS_12) $(LIBS_12) $(LIBS) 
...
$(CONFIG)/obj/makerom.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/makerom.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/paks/mpr/makerom.c
...
$(CONFIG)/bin/makerom: $(DEPS_14)
	...
	$(CC) -o $(CONFIG)/bin/makerom $(LIBPATHS) "$(CONFIG)/obj/makerom.o" $(LIBPATHS_14) $(LIBS_14) $(LIBS_14) $(LIBS) $(LIBS) 
...
$(CONFIG)/obj/pcre.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/paks/pcre/pcre.c
...
$(CONFIG)/obj/httpLib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/httpLib.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/paks/http/httpLib.c
...
$(CONFIG)/bin/libhttp.so: $(DEPS_20)
	...
	$(CC) -shared -o $(CONFIG)/bin/libhttp.so $(LIBPATHS) "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_20) $(LIBS_20) $(LIBS_20) $(LIBS) 
...
$(CONFIG)/obj/http.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/http.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/paks/http/http.c
...
$(CONFIG)/bin/http: $(DEPS_22)
	...
	$(CC) -o $(CONFIG)/bin/http $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_22) $(LIBS_22) $(LIBS_22) $(LIBS) $(LIBS) 
...
$(CONFIG)/obj/ejsLib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsLib.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/paks/ejs/ejsLib.c
...
$(CONFIG)/bin/libejs.so: $(DEPS_27)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.so $(LIBPATHS) "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_27) $(LIBS_27) $(LIBS_27) $(LIBS) 
endif
...
$(CONFIG)/obj/ejs.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejs.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/paks/ejs/ejs.c
...
$(CONFIG)/bin/ejs: $(DEPS_29)
	...
	$(CC) -o $(CONFIG)/bin/ejs $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_29) $(LIBS_29) $(LIBS_29) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/obj/ejsc.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsc.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/paks/ejs/ejsc.c
...
$(CONFIG)/bin/ejsc: $(DEPS_31)
	...
	$(CC) -o $(CONFIG)/bin/ejsc $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_31) $(LIBS_31) $(LIBS_31) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/obj/pak.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pak.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cmd/pak.c
