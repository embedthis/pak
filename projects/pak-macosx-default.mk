...
$(BUILD)/bin/libmpr.dylib: $(DEPS_25)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmpr.dylib -compatibility_version 0.10 -current_version 0.10 "$(BUILD)/obj/mprLib.o" $(LIBPATHS_25) $(LIBS_25) $(LIBS_25) $(LIBS) 
...
$(BUILD)/bin/libhttp.dylib: $(DEPS_27)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libhttp.dylib -compatibility_version 0.10 -current_version 0.10 "$(BUILD)/obj/httpLib.o" $(LIBPATHS_27) $(LIBS_27) $(LIBS_27) $(LIBS) 
endif
...
$(BUILD)/bin/libejs.dylib: $(DEPS_29)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.dylib -compatibility_version 0.10 -current_version 0.10 "$(BUILD)/obj/ejsLib.o" $(LIBPATHS_29) $(LIBS_29) $(LIBS_29) $(LIBS) 
endif
...
DEPS_32 += src/pak.es
DEPS_32 += paks/ejs-version/Version.es
ifeq ($(ME_COM_EJS),1)
    DEPS_32 += $(BUILD)/bin/ejs.mod
endif

$(BUILD)/bin/pak.mod: $(DEPS_32)
...
DEPS_33 += $(BUILD)/bin/pak.mod
DEPS_33 += $(BUILD)/obj/pak.o
...
$(BUILD)/bin/pak: $(DEPS_33)
	@echo '      [Link] $(BUILD)/bin/pak'
	$(CC) -o $(BUILD)/bin/pak -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/pak.o" $(LIBPATHS_33) $(LIBS_33) $(LIBS_33) $(LIBS) 

#
#   roots.crt
#
DEPS_34 += src/certs/roots.crt

$(BUILD)/bin/roots.crt: $(DEPS_34)
