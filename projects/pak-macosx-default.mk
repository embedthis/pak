...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_26)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 0.8.2 -current_version 0.8.2 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_26) $(LIBS_26) $(LIBS_26) $(LIBS) 
...
$(CONFIG)/bin/pak: $(DEPS_29)
	...
	$(CC) -o $(CONFIG)/bin/pak -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/pak.o" $(LIBPATHS_29) $(LIBS_29) $(LIBS_29) $(LIBS) 
