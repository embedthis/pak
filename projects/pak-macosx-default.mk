...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_12)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmprssl.dylib -compatibility_version 1.0.0 -current_version 1.0.0 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_12) $(LIBS_12) $(LIBS_12) $(LIBS) 
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_20)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 1.0.0 -current_version 1.0.0 "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_20) $(LIBS_20) $(LIBS_20) $(LIBS) 
...
$(CONFIG)/bin/libejs.dylib: $(DEPS_27)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.dylib -compatibility_version 1.0.0 -current_version 1.0.0 "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_27) $(LIBS_27) $(LIBS_27) $(LIBS) 
endif
...
pak.mod: $(DEPS_33)
	/Users/mob/git/pak/macosx-x64-default/bin/ejsc --out /Users/mob/git/pak/macosx-x64-default/bin/pak.mod --optimize 9 src/pak.es
#
#   pak.o
#
